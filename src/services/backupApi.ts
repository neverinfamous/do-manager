...
export const backupApi = {
  ...
  async listForInstance(
    ...
    const data = await apiFetch<BackupsResponse>(
  ...
  async create(instanceId: string): Promise<Backup> {
    const data = await apiFetch<BackupResponse>(
      `/instances/${instanceId}/backups`,
      {
        method: "POST",
      },
  ...
  async restore(
    ...
    const result = await apiFetch<RestoreResponse>(
      `/instances/${instanceId}/restore/${backupId}`,
      {
        method: "POST",
      },
    );
